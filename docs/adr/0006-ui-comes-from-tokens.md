...
- **The one declared exception is `--family`**, set inline per tile from `FAMILY_COLOR` in core. The keyword palette has exactly one home and it is ADR-0005's, not this one.
